...
const Admin = () => {
  ...
  useEffect(() => {
    ...
    const getKyc = async () => {
      await axios
        .get("https://bitclub-server.vercel.app/fetchAllKyc")
        .then((data) => {
          if (data.data.kyc) {
  ...
  const handleKyApprove = async () => {
    ...
    await axios
      .post("https://bitclub-server.vercel.app/approveKyc", { kycApprove })
      .then((data) => {
        if (data.data.success) {
          setLoading9(false);
          toast.success(data.data.success);
  ...
  const handleKyDecline = async () => {
    ...
    await axios
      .post("https://bitclub-server.vercel.app/declineKyc", { kycDecline })
      .then((data) => {
        if (data.data.success) {
          setLoading8(false);
          toast.success(data.data.success);
  ...
  const handleKycAction = async () => {
    ...
    await axios
      .post("https://bitclub-server.vercel.app/deleteKyc", { kycAction })
      .then((data) => {
        if (data.data.success) {
          toast.success(data.data.success);
          setLoading7(false);
    ...
    <div>
      ...
      <div style={{ marginTop: "80px" }} className="container-scroller">
        ...
        <Modal className="mt-4" show={show} onHide={handleClose}>
          ...
          <Modal.Body className="bg-dark">
            <Form className="card-gradient">
              ...
              >
                <InputGroup className="mb-3">
                  ...
                  <Form.Control
                    ...
                    aria-label="Amount (to the nearest dollar)"
                  />
                  <InputGroup.Text className="card-gradient">
                    .00
                  </InputGroup.Text>
                </InputGroup>
              </Form.Group>
              <Form.Select
                value={adder.type}
                onChange={(e) => setAdder({ ...adder, type: e.target.value })}
                className="bg-dark"
        ...
        <Modal className="mt-4" show={show3} onHide={handleClose3}>
          ...
          <Modal.Body className="bg-dark modal-body-scroll">
            <Form>
              <div className="card-title text-warning">Custom Mailer!</div>
              <Form.Group
                className="mb-3"
                controlId="exampleForm.ControlInput1"
              >
                      ...
                      <div className="row">
                        <div className="col-10">
                          ...
                          <div
                            ...
                            className="d-flex mt-2 align-items-center align-self-start"
                          >
                      ...
                      <div className="row" style={{ paddingBottom: "80px" }}>
                        ...
                        >
                          ...
                          <button
                            ...
                            className="btn p-2 btn-gray mt-4"
                          >
                            Balance Adder
                            <span className="fas m-1 fa-plus"></span>
                          </button>
                        </div>
                        <div
                          style={{ marginBottom: "-50px" }}
                        ...
                        >
                          ...
                          >
                            message sender
                            <span className="fa fa-paper-plane m-1"></span>
                          </button>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="form-group row">
                        <div className="col">
                          ...
                          <button
                            ...
                            className="btn p-2 btn-gray "
                          >
                            View | Users
                            <span className="fas m-1 fa-arrow-down"></span>
                          </button>
                        </div>
                        <div className="col">
                          ...
                          <form onSubmit={upgradeAccount}>
                            <div className="mb-3">
                              <div id="emailHelp" className="form-text">
                                Please provide the user ID to be Upgraded.
                              </div>
                              <input
                                type="text"
                                value={UID.ID}
                            ...
                            <div className="mb-3">
                              <div id="emailHelp" className="form-text">
                                Please select the Level you want to be upgraded
                                to.
                              </div>
                              <select
                                value={UID.ULevel}
