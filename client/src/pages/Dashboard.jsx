...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchKyc = async () => {
      try {
        await axios
          .post("https://bitclub-server.vercel.app/fetchKyc", { email })
          .then((data) => {
            if (data.data.status) {
    ...
    const fetchOTP = async () => {
      try {
        await axios
          .post("https://bitclub-server.vercel.app/fetchOTP", { email })
          .then((data) => {
            if (data.data.status) {
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            {Otp === "Verified" ? (
                              ...
                              <td>
                                <label className="badge p-0 float-right bg-warning text-white p-2">
                                  Unverified
                                </label>
                              </td>
                            )}
                          ...
                          <tr>
                            ...
                            <td>
                              {kyc === "Verified" ? (
                                ...
                                <label className="badge p-0 float-right bg-danger text-white p-2">
                                  Unverified
                                </label>
                              )}
                            </td>
